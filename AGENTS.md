...
- Dal 2026-09-05 anche il manager puo' registrare una delega dalla voce `Delega` del menu Presenza nella scheda invito; nome, cognome ed email sono obbligatori, mentre Ruolo/Carica e' facoltativo sia qui sia nel link pubblico.
...
- Variabili server necessarie per magic link e invii evento: `GMAIL_USER` e `GMAIL_APP_PASSWORD`.
